...
// the PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP mutex doesn't seem to be
// available on Android, so I removed all mutexes, because we are
// in another thread so it doesn't matter ...


// static pthread_mutex_t window_mutex=PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP;
// static pthread_mutex_t window_mutex = PTHREAD_MUTEX_INITIALIZER;  // Android
