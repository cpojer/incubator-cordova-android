...
// Auphonic Android NOTE:
// define the ugly float32 hack right here
#define UGLY_IEEE754_FLOAT32_HACK 1


// Auphonic Android NOTE:
// it seems that M_PIl is not defined on all Android targets ...
#ifndef M_PIl
...
// Auphonic NOTE: in C++ we don't have to define these two
#ifndef __cplusplus
#define _GNU_SOURCE
...
#include <sys/types.h>
#include <sys/time.h>
// Auphonic NOTE: disabled __USE_GNU because of problems with some compilers ...
// #define __USE_GNU 1
#include <pthread.h>
#include <string.h>
#include <math.h>
...
// Auphonic NOTE: also disable these utility functions!
